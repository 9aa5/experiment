...
- (void) initPath:(NSString*)path Height:(int) cy width:(int) cx channels: (int) ch samples:(Float64) rate;
{
    ...
    [compressionProperties setObject: [NSNumber numberWithInt: 200 * 1024] forKey: AVVideoAverageBitRateKey];
    [compressionProperties setObject: [NSNumber numberWithInt: 8] forKey: AVVideoMaxKeyFrameIntervalKey];
